...
public class CreateNewExcelAndWrite {
	...
	public static void main(String[] args) {
        ...
        XSSFSheet sheet
            = workbook.createSheet("Mir Family");
        ...
        data.put("2",
                 new Object[] { 1, "Mahmud", "Mir" });
        data.put("3",
                 new Object[] { 2, "Mahbub", "Mir" });
        data.put("4", 
        		new Object[] { 3, "Sayeed", "Mir" });
        data.put("5", 
        		new Object[] { 4, "Khalid", "Mir" });
        ...
        try {
            ...
            // program
            System.out.println(
                "MirFamily.xlsx written successfully on disk.");
        }
