...
public class WebTablesDemo2 {
	...
	public static void main(String[] args) {
		...
		//driver.navigate().to("https://www2.asx.com.au/markets/trade-our-cash-market/equity-market-prices");
		...
		for (int i=2; i<=rowsize; i++) {
			for (int j=1; j<=columnsize; j++) {
				...
				if (columntext.equalsIgnoreCase("Roland Mendel")) {
	                break;
				}
